...
const lirisExtractRef  = useRef(lirisExtract)
  ...
  // (abgesagt gilt wie erledigt als abgeschlossen → ebenfalls eingeklappt)
  useEffect(() => { setZwEditExpanded(form.zuweisungStatus !== 'erledigt' && form.zuweisungStatus !== 'abgesagt') }, [editTarget]) // eslint-disable-line react-hooks/exhaustive-deps
          ...
          >
            ...
            <div className="overflow-y-auto flex-1 px-4 py-3.5 space-y-3">
              ...
              <div className="pt-3 border-t border-gray-100">
                ...
                {form.zuweisungAktiv && (form.zuweisungStatus === 'erledigt' || form.zuweisungStatus === 'abgesagt') && !zwEditExpanded && (
                  <div className={`flex items-center gap-2 px-2.5 py-2 rounded-lg border text-xs ${form.zuweisungStatus === 'abgesagt' ? 'border-gray-200 bg-gray-50' : 'border-green-200 bg-green-50'}`}>
                    {form.zuweisungStatus === 'abgesagt'
                      ? <span className="px-1.5 py-0.5 rounded-full bg-gray-100 text-gray-500 font-semibold shrink-0">Abgesagt</span>
                    ...
                    {form.zuweisungStatus === 'erledigt' && !form.zuweisungBerichtErhalten && <span className="text-amber-600 font-semibold shrink-0">· Bericht ausstehend</span>}
                ...
                {form.zuweisungAktiv && ((form.zuweisungStatus !== 'erledigt' && form.zuweisungStatus !== 'abgesagt') || zwEditExpanded) && (
                  <div className="space-y-2 rounded-xl border border-violet-200 bg-violet-50 p-3">
                    {(form.zuweisungStatus === 'erledigt' || form.zuweisungStatus === 'abgesagt') && (
